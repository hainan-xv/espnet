...
parser.add_argument('--train_labels', type=str, help='train text')
parser.add_argument('--valid_labels', type=str, help='valid text')
...
def get_batch(sequences, volatile=False, cuda=False):
...
#        state = {'c1': c1, 'h1': h1, 'c2': c2, 'h2': h2}
     ...
     def seq_forward(self, sequences):
         ...
         return self.proj(rnn_output.view(-1, self.n_units))
...
#test  = list(read(test_file))
  ...
  S = w2i['<s>']
  print ("vocab size is ", args.vocab_size)
